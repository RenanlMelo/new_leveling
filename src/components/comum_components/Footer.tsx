    ...
    <footer className="bg-black text-white pt-8 font-2 border-t border-[#505050]">
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row justify-between items-center gap-6">
        ...
        <div className="grid grid-cols-2 w-full">
          <div className="grid grid-rows-2 gap-y-2 justify-center items-center text-center h-full md:text-right text-sm space-x-4">
          ...
          <div className="grid grid-rows-2 gap-y-2 justify-center items-center w-full">
            <a
              href="https://www.linkedin.com/company/leveling-corporation/"
              target="_blank"
              aria-label="LinkedIn"
              className="hover:text-gray-400 flex gap-x-2 justify-start items-center"
            >
              <svg
